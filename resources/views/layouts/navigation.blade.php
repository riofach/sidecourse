            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')"
                        class="transition-colors duration-300 hover:text-indigo-500 dark:hover:text-indigo-400">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                    ...
                    @role('owner')
                        ...
                        <x-nav-link :href="route('admin.subscribe_transaction.index')" :active="request()->routeIs('admin.subscribe_transaction.index')"
                            class="transition-colors duration-300 hover:text-indigo-500 dark:hover:text-indigo-400">
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profile.edit')"
                            class="transition-colors duration-300 hover:bg-gray-100 dark:hover:bg-gray-700">
                            {{ __('Profile') }}
                        </x-dropdown-link>
