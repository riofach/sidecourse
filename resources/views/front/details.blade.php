            ...
            <div
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div
                        ...
                        <p class="font-semibold group-hover:text-white transition-all duration-300 text-white">Install
                            Figma on Windows</p>
                    </div>
                    <div
                        class="group p-[12px_16px] flex items-center gap-[10px] bg-[#E9EFF3] rounded-full hover:bg-[#3525B3] transition-all duration-300">
                        ...
                        <p class="font-semibold group-hover:text-white transition-all duration-300">Download Templates
                        </p>
                    </div>
                    <div
                        class="group p-[12px_16px] flex items-center gap-[10px] bg-[#E9EFF3] rounded-full hover:bg-[#3525B3] transition-all duration-300">
                        ...
                        <p class="font-semibold group-hover:text-white transition-all duration-300">Understanding Briefs
                        </p>
                    </div>
                    <div
                        class="group p-[12px_16px] flex items-center gap-[10px] bg-[#E9EFF3] rounded-full hover:bg-[#3525B3] transition-all duration-300">
                        ...
                        <p class="font-semibold group-hover:text-white transition-all duration-300">Create a Database
                        </p>
                    </div>
                    <div
                        class="group p-[12px_16px] flex items-center gap-[10px] bg-[#E9EFF3] rounded-full hover:bg-[#3525B3] transition-all duration-300">
                        ...
                        <p class="font-semibold group-hover:text-white transition-all duration-300">Prepare All New
                            Seeders</p>
                    </div>
                    <div
                        class="group p-[12px_16px] flex items-center gap-[10px] bg-[#E9EFF3] rounded-full hover:bg-[#3525B3] transition-all duration-300">
                        ...
                        <p class="font-semibold group-hover:text-white transition-all duration-300">Install Figma on
                            Windows</p>
                    </div>
                    <div
                        class="group p-[12px_16px] flex items-center gap-[10px] bg-[#E9EFF3] rounded-full hover:bg-[#3525B3] transition-all duration-300">
                        ...
                        <div id="About" class="tabcontent hidden">
                            <div class="flex flex-col gap-5 w-[700px] shrink-0">
                                ...
                                <p class="font-medium leading-[30px]">
                                    Pada kelas ini kita akan belajar bersama dengan mentor berpengalaman dalam membangun
                                    sebuah website dengan studi kasus ujian online (computer based test) yang dapat
                                    membantu guru atau manager dalam menilai pengetahuan dari setiap student dan
                                    karyawan mereka.
                                </p>
                                <p class="font-medium leading-[30px]">
                                    Kita akan menggunakan framework php popular yaitu adalah laravel sehingga proses
                                    pengembangan website CBT menjadi lebih cepat dan mudah diperbesar bersama dengan
                                    developer/programmer lainnya suatu saat nanti. <br>
                                    Projek pada kursus online ini nanti akan terbagi oleh dua user role yaitu
                                    teacher/manager dan student/karyawan, kita akan membataskan beberapa fitur sehingga
                                    hanya bisa diakses oleh setiap role tersebut (bagus untuk user experience).
                                </p>
                                <div class="grid grid-cols-2 gap-x-[30px] gap-y-5">
                                    <div class="benefit-card flex items-center gap-3">
                                        ...
                                        <p class="font-medium leading-[30px]">Dolor si amet exercise better garrer axia
                                            certificate guarantee job</p>
                                    </div>
                                    <div class="benefit-card flex items-center gap-3">
                                        <div class="w-6 h-6 flex shrink-0">
                                            <img src="{{ asset('assets/icon/tick-circle.svg') }}" alt="icon">
