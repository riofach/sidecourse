            ...
            <div
                ...
                <div class="flex flex-col gap-3">
                    ...
                    @forelse ($course->course_videos as $video)
                        ...
                        <div
                            class="group p-[12px_16px] flex items-center gap-[10px] {{ $isActive ? 'bg-[#3525B3]' : 'bg-[red]' }}  rounded-full hover:bg-[#3525B3] transition-all duration-300">
                            <div class="text-black group-hover:text-white transition-all duration-300">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    @empty
                        <p>Teacher haven't add videos</p>
                    @endforelse
