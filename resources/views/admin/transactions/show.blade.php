        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div class="flex flex-row gap-x-10">
                    ...
                    @else
                        <svg width="100" height="100" fill="#000000" height="200px" width="200px" version="1.1"
                    ...
                    <div class="flex flex-col gap-y-10">
                        <div>
                            ...
                            <h3 class="text-indigo-950 dark:text-indigo-200 text-xl font-bold">Rp
                                {{ $subscribeTransaction->total_amount }}
                            </h3>
                        </div>
                        <div>
                            <p class="text-slate-500 dark:text-slate-400 text-sm mb-2">Status</p>
                            @if ($subscribeTransaction->is_paid)
                                <span class="text-sm font-bold py-2 px-3 rounded-full bg-green-500 text-yellow-50">
                                    ACTIVE
                                </span>
                            @else
                                <span class="text-sm font-bold py-2 px-3 rounded-full bg-orange-500 text-yellow-50">
                                    PENDING
                                </span>
                            @endif
                        </div>
                        <div>
                            <p class="text-slate-500 dark:text-slate-400 text-sm">Checkout Date</p>
                            <h3 class="text-indigo-950 dark:text-indigo-200 text-xl font-bold">
                                {{ $subscribeTransaction->created_at }}</h3>
                        </div>
                        <div>
                            <p class="text-slate-500 dark:text-slate-400 text-sm">Subscription Start</p>
                            <h3 class="text-indigo-950 dark:text-indigo-200 text-xl font-bold">
                        ...
                        <div class="">
                            ...
                            <h3 class="text-indigo-950 dark:text-indigo-200 text-xl font-bold">
                                {{ $subscribeTransaction->user->name }}</h3>
                        </div>
                    </div>
                    <div>
