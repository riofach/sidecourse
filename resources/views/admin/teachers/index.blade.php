                    ...
                    <div
                        ...
                        <div class="flex flex-row items-center gap-x-3">
                            <img src="{{ Storage::url($teacher->user->avatar) }}" alt=""
                                class="rounded-2xl object-cover w-[90px] h-[90px] transition-all duration-300 ease-in-out transform hover:scale-110">
                            <div class="flex flex-col">
                                <h3 class="text-indigo-950 dark:text-indigo-200 text-xl font-bold">
                                    {{ $teacher->user->name }}</h3>
                                <p class="text-slate-500 dark:text-slate-400 text-sm">{{ $teacher->user->occupation }}
                                </p>
                            </div>
                        </div>
