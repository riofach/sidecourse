    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div class="item-card flex flex-row gap-y-10 justify-between items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        <img src="{{ Storage::url($course->thumbnail) }}" alt=""
                            class="rounded-lg object-cover w-[120px] h-[90px] transition-all duration-300 ease-in-out transform hover:scale-110">
                ...
                <div class="flex flex-row justify-between items-center">
                    <div class="flex flex-col">
                        <h3 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Course Videos
                        </h3>
                        <p class="text-slate-500 dark:text-slate-400 text-sm">{{ $course->course_videos->count() }}
                            Total Videos</p>
                    </div>
                    {{-- kenapa ada id nya ($course->id) -> karena di route dia minta id --}}
                ...
                {{-- $course dilempar dari coursecontroller fungsi show dan course_videos itu dari modelnya karena ada relasi --}}
